...
case "11":
	...
	$active="1";
	$clsFunciones = new clsFunciones;
	$insert = $clsFunciones->insertusuarios($username,$password,$first_name,$last_name,$email,$phone,$id_componente,$id_group,$created_on,$active);
...
case "12":
	...
	$active="1";
	$clsFunciones = new clsFunciones;
	$insert = $clsFunciones->updateusuarios($id,$username,$password,$first_name,$last_name,$email,$phone,$id_componente,$id_group,$created_on,$active);
	$regresar="creacionusuarios.php?id=0";
	break;
...
case "15":
	...
	$regresar="evaluarsemaforo.php?id_contrato=".$id_contrato."&id_mes=".$id_mes."&id_tema=".$id_tema;
	break;

case "16":

	//Variables de configuracion
	$peso_mb=5; //Tamaño limite en MB del archivo a subir
...
case "22":
	...
	$clsFunciones = new clsFunciones;
	$insert = $clsFunciones->insertdescuentos($acta, $fecha, $interventor, $matriculados, $asistentes, $alimentacion, $descripcion, $medida, $alimento, $detallealimento, $faltante, $grupoedad, $total, $observaciones, $estado, $usuario);
