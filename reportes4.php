		...
		if ($numrows == 0){
			...
			<div class="alert alert-default" role="alert">
				<center> <p> <img src="images/pascualbravo.jpg" width="200" height="60"> </p>
					<h2><center>Valoración Consolidada de Calidad por Contrato</strong></h2>
				...
				<table align="center" class="table table-bordered table-hover" id='table' style="width: 95%">
					<thead>
						<tr>
							...
							<!-- <th rowspan="1" class="success">%Prom. Calidad</th> -->
							...
							<tr>
								...
								(
                                    ...
                                    $total = $promedio_componente - $descuento;
																		?>
																		<td class="active" align="center"><?php echo $total ?>%</td>
																		<?php
																	}
                                            ...
                                            //
																						// 	if($row['suma_total_inicial']!=""){
																						// 		?>
																								<!-- <td class="active" align="center"><?php echo $row['suma_total_inicial']*100; ?>%</td> -->
																								<?php
																						// 	}
                                            //
																						// 	else{
