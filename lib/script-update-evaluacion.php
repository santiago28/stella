  ...
  (
    ...
    FROM(
      ...
      (
        ...
        $suma_inicial = array_sum($porc_inicial);
        $suma_porc_inicial=array_sum($porc_inicial)/$cantidad;
        $suma_porc_final=array_sum($porc_final)/$cantidad;
        //$suma_porc_componente_x_final=array_sum($porc_componente_x_final)/$suma_porc_referencia;


        //Update: Actualizar porcentajes en la tabla evaluaci�n
